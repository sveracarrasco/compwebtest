 ...
 * @author sarayar
 */
@WebServlet(name = "procesaController", urlPatterns = {"/procesa.do"})
public class ProcesaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nombre.isEmpty() || perfil.isEmpty()){
            request.setAttribute("msg", "Error en parametros");
        } else {
            request.setAttribute("msg", "Datos correctos " + nombre + "|" + perfil);
        }
